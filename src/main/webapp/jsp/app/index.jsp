...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <form class="layui-form" action="${ctx}/app/${sessionScope.devUser.id}/query" method="post">
                <div class="layui-form-item">
                    <div class="layui-input-inline">
                        <input type="hidden" name="pageNum"   lay-verify="required" value="1">
                    </div>
                    <label class="layui-form-label">软件名称</label>
                    <div class="layui-input-inline">
                        <input type="text" name="softwareName"   placeholder="请输入名称" autocomplete="off" class="layui-input" value="${appInfoDTO.softwareName}">
                    </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <a href="${ctx}/app/toAdd" class="layui-btn">新增APP基础信息</a>
                </div>
            </div>
                ...
                <tbody>
                    <c:forEach items="${page.list}" var="obj">
                        <tr>
                            ...
                            <td>${obj.appFlatform.valueName}</td>
                            <td>
                                ${obj.categoryLevel1.categoryName}->${obj.categoryLevel2.categoryName}->
                                ${obj.categoryLevel3.categoryName}
                            </td>
                            <td>${obj.appStatus.valueName}</td>
                            <td>${obj.downloads}</td>
                            <td>${obj.newsAppVersion.versionNo}</td>
                            <td>
                                ...
                                <a href="${ctx}/app/app/queryById/${obj.id}" class="layui-btn"><i class="layui-icon ">&#xe615;</i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    <tr>
